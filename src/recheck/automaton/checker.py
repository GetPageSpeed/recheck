...
from recheck.parser.parser import parse, Pattern
from recheck.parser.flags import Flags
from recheck.parser.ast import has_backreferences
...
from recheck.automaton.witness import generate_attack_from_witness
